    ...
    >
      ...
      <div className="relative flex flex-col items-center">
        ...
        <div className="relative mb-8 h-24 w-24">
          ...
          <div className="absolute left-1/2 top-1/2 grid h-10 w-10 -translate-x-1/2 -translate-y-1/2 rotate-45 place-items-center rounded-xl bg-gradient-to-br from-forge-500 to-forge shadow-[0_12px_36px_-10px_rgba(124, 120, 240,0.6)]">
        ...
        <div className="mt-4 h-1 w-56 overflow-hidden rounded-full bg-line">
          <div
            className="h-full rounded-full bg-forge transition-[width] duration-100 ease-out"
