    ...
    <>
      ...
      <style jsx>{`
        ...
        .ai-ping {
          ...
          border-radius: 9999px; border: 1.5px solid rgba(99,102,241,0.6);
        ...
        .ai-nudge {
          ...
          background: rgba(19,16,23,0.95); color: #ededed; border: 1px solid rgba(99,102,241,0.35);
        ...
        .ai-panel {
          ...
          border: 1px solid rgba(99,102,241,0.28); border-radius: 1.1rem;
          box-shadow: 0 30px 80px rgba(0,0,0,0.6); color: #ededed;
        ...
        .ai-sub { font-size: 0.66rem; color: rgba(237,237,237,0.5); text-transform: lowercase; }
        .ai-head-actions { display: flex; gap: 0.25rem; }
        .ai-icon { display: grid; place-items: center; width: 30px; height: 30px; border-radius: 0.5rem; background: transparent; border: 0; color: rgba(237,237,237,0.65); cursor: pointer; transition: all 0.18s; }
        ...
        .ai-msg-user { align-self: flex-end; background: linear-gradient(180deg, #6366f1, #4f46e5); color: #ffffff; font-weight: 600; border-bottom-right-radius: 0.25rem; }
        .ai-src { display: block; font-size: 0.58rem; text-transform: uppercase; letter-spacing: 0.08em; color: #818cf8; margin-bottom: 0.25rem; font-weight: 700; }
        .ai-typing { display: inline-flex; gap: 4px; padding: 2px 0; }
        .ai-typing i { width: 6px; height: 6px; border-radius: 9999px; background: rgba(129,140,248,0.8); animation: ai-bounce 1.1s infinite ease-in-out; }
        ...
        .ai-suggest button {
          font-size: 0.68rem; color: rgba(237,237,237,0.8); background: rgba(255,255,255,0.04);
          border: 1px solid rgba(255,255,255,0.1); border-radius: 9999px; padding: 0.35rem 0.7rem; cursor: pointer; transition: all 0.18s;
        }
        .ai-suggest button:hover { border-color: rgba(99,102,241,0.55); color: #818cf8; }
        ...
        .ai-input input { flex: 1; background: rgba(255,255,255,0.05); border: 1px solid rgba(255,255,255,0.1); border-radius: 0.7rem; padding: 0.55rem 0.7rem; color: #ededed; font-size: 0.8rem; outline: none; }
        .ai-input input:focus { border-color: rgba(99,102,241,0.5); }
        .ai-input input::placeholder { color: rgba(237,237,237,0.4); }
        ...
        .ai-mic { background: rgba(255,255,255,0.06); color: rgba(237,237,237,0.7); }
        .ai-mic.on { background: #6366f1; color: #ffffff; animation: ai-pulse 1s infinite; }
        @keyframes ai-pulse { 0%,100% { box-shadow: 0 0 0 0 rgba(99,102,241,0.5); } 50% { box-shadow: 0 0 0 6px rgba(99,102,241,0); } }
        .ai-send { background: linear-gradient(180deg, #6366f1, #4f46e5); color: #ffffff; }
        ...
        .ai-mic:focus-visible { outline: 2px solid #818cf8; outline-offset: 2px; }
